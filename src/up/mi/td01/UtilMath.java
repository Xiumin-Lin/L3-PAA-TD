...
public class UtilMath {
	...
	public static long fact(int n) throws IllegalArgumentException {
		if(n < 0)
			throw new IllegalArgumentException("fact(" + n + ") impossible, n doit etre positif !");
	 ...
	 * @param p value
	 * @return (n p)
	 * @throws IllegalArgumentException if p > n
	 */
	public static long comb(int n, int p) throws IllegalArgumentException {
		if(p > n)
			throw new IllegalArgumentException("comb(" + n + " " + p + ") est impossible ! p ne doit pas etre plus grand que n !");
	 ...
	 * @return n**m
	 */
	public static long power(int n, int m) throws IllegalArgumentException {
		if(m < 0) throw new IllegalArgumentException("La valeur pour la puissance ne peut pas etre negatif !");
		long l = 1;
		for(int i = 0; i < m; i++) {
			l *= n;
		}
	...
	// ---------- Ex 6 ----------
	public static void showMathInterface() {
			...
			try {
				...
				switch(choice) {
					...
					case 0:
						...
						break;
					default:
						throw new IllegalArgumentException("Ce choix n'existe pas !");
				}
			} catch(InputMismatchException e1) {
				System.out.println("Le type de l'input est invalide !");
			} catch(Exception e) {
